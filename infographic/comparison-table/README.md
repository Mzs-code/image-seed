...
| [info-comparison-table-claude-code-access](./info-comparison-table-claude-code-access.png) | 接入 Claude Code 的两种方式(官方订阅 vs 中转站) | `claude-code` `blue` `flowchart` `gemini` `handwritten` | Gemini 生成 | — |
