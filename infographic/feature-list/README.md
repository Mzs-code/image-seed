...
| [info-feature-list-anthropic-enterprise-share](./info-feature-list-anthropic-enterprise-share.webp) | 企业客户开始倒向 Anthropic:采购份额 34.4% 首超 OpenAI、Claude Code 千家大客户、单元经济持续改善多板块数据卡 | `anthropic` `claude-code` `enterprise` `market-share` `purple-orange` `chinese` `gpt-image-2` | 新智元·好困 | — |
